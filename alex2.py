...
train_data_dir = "/mnt/E/x/HandWrittenChineseRecogntion/data/train" #"HWDB1.1trn_gnt"
test_data_dir = "/mnt/E/x/HandWrittenChineseRecogntion/data/test" #"HWDB1.1tst_gnt"

# Python的str默认是ascii编码，和unicode编码冲突. https://blog.csdn.net/hyman_c/article/details/53444080
import sys
reload(sys)
...
def train_hand_write_cnn():
    ...
    # TensorBoard
    # tf.scalar_summary("loss", loss) https://blog.csdn.net/lijjianqing/article/details/70155905
    tf.summary.scalar("loss", loss)
    # tf.scalar_summary("accuracy", accuracy) https://blog.csdn.net/lijjianqing/article/details/70155905
    tf.summary.scalar("accuracy", accuracy)
    # merged_summary_op = tf.merge_all_summaries() https://blog.csdn.net/lijjianqing/article/details/70155905
    # merged_summary_op = tf.summaries.merge_all(key='summaries')
    # merged_summary_op = tf.summaries.merge_all(key=tf.GraphKeys.SUMMARIES) # 
    ...
    with tf.Session() as sess:
        ...
        # https://blog.csdn.net/chencaw/article/details/78557903
